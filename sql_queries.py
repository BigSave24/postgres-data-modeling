...
songplay_table_create = ("""
    CREATE TABLE IF NOT EXISTS songplays (
        ...
        user_id integer NOT NULL, level varchar, song_id varchar, 
...
song_table_create = ("""
    CREATE TABLE IF NOT EXISTS songs (
        ...
        artist_id varchar, year integer, duration float NOT NULL
    );
    """)
...
time_table_create = ("""
    CREATE TABLE IF NOT EXISTS time (
        start_time timestamp PRIMARY KEY, hour integer, day varchar, 
        week integer, month varchar, year integer, weekday integer
    );
    """)
